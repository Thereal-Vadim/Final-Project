...
SECRET_KEY = 'django-insecure-obr+c690wjsans#h+c=-ssvn9sa1_afsj8n#urhz53t97sva+5'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # Позволяет искать шаблоны в папках приложений (например, flowers/templates)
        'OPTIONS': {
            'context_processors': [
